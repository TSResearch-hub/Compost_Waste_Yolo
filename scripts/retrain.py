...
def main():
    ...
    ap.add_argument("--pretrain", default="models/v0_pretrain_yolov8n.pt",
                    help="modèle pré-entraîné de départ (défaut : models/v0_pretrain_yolov8n.pt)")

 ...
 * Matériel (flotte Jetson), Modèles IA (poids pour la flotte), Dataset
 * (export ZIP, dépôt d'images depuis le PC) et Technique. */
        ...
        <div className="barre-droite">
          {admin && (
            <>
              ...
              <button className="btn btn-petit" onClick={onOuvrirDataset}>
                Dataset
              </button>
